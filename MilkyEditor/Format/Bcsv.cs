...
namespace MilkyEditor
{
    public class Bcsv
    {
            ...
            for (uint i = 0; i < entrycount; i++)
            {
                ...
                foreach (Field field in Fields.Values)
                {
                    ...
                    switch (field.Type)
                    {
                        case 0:
                        case 3:
                            val = (int)((m_File.Reader.ReadUInt32() & field.Mask) >> field.ShiftAmount);
                            break;
        ...
        public static List<string> knownShit = new List<string>
        {
            "Range",
            "Distant",
            "Priority",
            ...
            "WaterFlag",
            "IndirectFlag",
            "ForceLowScenarioName0",
            "ForceLowScenarioName1",
            "ForceLowScenarioName2",
            "ForceLowScenarioName3",
            "ForceLowScenarioName4",
            "ForceLowScenarioName5",
            "ForceLowScenarioName6",
            "ForceLowScenarioName7",
            "en_name",
            "jp_name",
            "ModelName",
            "ClassName",
        ...
        public static void PopulateHashtable()
        {
            ...
            foreach (string line in knownShit)
            {
                AddHash(line);
            }
        }
